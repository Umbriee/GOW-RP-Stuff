--==| Grabbed from helixs' base weapon code. Just modified lightly to hopefully play nicely with ASTW2 weaponry. |==--
ITEM.name = "Weapon"
ITEM.description = "A Weapon." -- To surpass COG Gear.
...
function ITEM:Equip(client, bNoSelect, bNoSound)
	...
	timer.Simple(0.05, function()
		...
		if IsValid(weapon) then
			...
			print(Format("[Helix] Cannot equip weapon - %s doesn't exist or they already have one!", self.class))
		end
	end)
end
...
--[[ -- Maybe. But I do like the behind cover fire anim.
function ITEM:OnRegistered()
	ALWAYS_RAISED[self.class] = true
end
--]]