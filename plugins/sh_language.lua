...
ix.flag.Add("L", "Azerbaijan", function(client, bGiven)
end)
...
CreateLangCommand ("az", "L", "says in azerbaijan", "says something in azerbaijan") -- Command, Flag, Format
CreateLangCommand ("jp", "J", "says in japanese", "says something in japanese") -- Command, Flag, Format
CreateLangCommand ("pl", "P", "says in polish", "says something in polish") -- Command, Flag, Format